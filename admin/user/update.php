...
<body>
 ...
 <nav  class="navbar navbar-expand-lg navbar-light px-5" style="background-color: #3B3131;">
  ...
  <h2 style="font-size:25px;padding:10px 10px 0;justify-content:center;display:flex">Sửa</h2>
    ...
    <label>Level: <input type="text" value="<?php echo $row['Level']?>" style="width:250px; margin-bottom:5px" name="level"></label><br>
    ...
    <?php
        ...
        // Ket not db
        include('../connect.php');
        $sql = "UPDATE `user` SET Email='$email', Level='$lv' WHERE ID='$id'";
